...
Per-sample tcool stored in nu field.

Usage:
    torchrun --nproc_per_node=8 finetune/train_turbulent_radiative_lora_v3.py --config configs/finetune_turbulent_radiative_v3.yaml
"""
...
def compute_pde_loss(
    ...
    Extracts vx, vy, density, pressure from denormalized model output,
...
def main():
    ...
    if accelerator.is_main_process:
        ...
        logger.info(f"Loss: BC + PDE (mass + x-mom + y-mom)")
    ...
    if accelerator.is_main_process:
        ...
        run_name = f"turbulent_radiative-lora-v3-r{lora_r}"
        accelerator.init_trackers(
            ...
            init_kwargs={"wandb": {
                ...
                "name": run_name,
                "tags": ["turbulent_radiative", "lora", "v3", "BC+PDE", "mass+momentum"],
            }}
        )
